export const CountryOptions = [
  ...
  { name: "Aruba", dial_code: "+297", code: "AW", flag: "🇦🇼", part_of: ["NL"] },
  {
    name: "Australia",
    dial_code: "+61",
    code: "AU",
  ...
  { name: "Guam", dial_code: "+1671", code: "GU", flag: "🇬🇺", part_of: ["US"] },
  ...
  { name: "Jersey", dial_code: "+44", code: "JE", flag: "🇯🇪", part_of: ["GB"] },
  {
    name: "Jordan",
    dial_code: "+962",
    code: "JO",
  ...
  { name: "Macao", dial_code: "+853", code: "MO", flag: "🇲🇴", part_of: ["CN"] },
  {
